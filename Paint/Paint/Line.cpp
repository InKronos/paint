...
Line::Line(sf::Vector2f mousePosition, sf::Color color, int thickness)
	: startingPosition(mousePosition), thickness(thickness)
{
...
void Line::update(sf::Vector2f mousePosition)
{
	...
	line.setSize(sf::Vector2f(this->thickness, size));
